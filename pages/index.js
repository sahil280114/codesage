        ...
        {messages.map((message, index) => {
          ...
          />
            ...
            <div className = {styles.footer}>
              <p>To teach the model new tools, send in the documentation url as "#learn: https://platform.openai.com/docs/guides/completion".</p><p>To see a list of tools people have taught the model use "#list-tools"</p>
            </div>
        </div>
      </main>
    </>
